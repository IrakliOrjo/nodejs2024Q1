...
var getTokenAndUserId = function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var mockUserId, _a, accessToken, refreshToken, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, request
                    ...
                    .send(createUserDto)];
            case 1:
                mockUserId = (_b.sent()).body.id;
                return [4 /*yield*/, request
                        .post(endpoints_1.authRoutes.login)
                        .set('Accept', 'application/json')
                        .send(createUserDto)];
            case 2:
                _a = (_b.sent()).body, accessToken = _a.accessToken, refreshToken = _a.refreshToken;
